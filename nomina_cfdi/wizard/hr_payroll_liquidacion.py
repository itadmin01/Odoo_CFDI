...
class GeneraLiquidaciones(models.TransientModel):
    ...
    def calculo_create(self):
        ...
        payslip_vals = dict(payslip_onchange_vals.get('value',{})) #TO copy dict to new dict. 
        ...
        payslip_vals2 = dict(payslip_onchange_vals.get('value',{}))
    ...
    def calculo_liquidacion(self):
        if self.employee_id and self.contract_id:
            ...
            delta_dias  = datetime.strptime(self.fecha_liquidacion,"%Y-%m-%d") - datetime.strptime(self.fecha_inicio,"%Y-%m-%d")
    ...
    def get_fondo_ahorro(self):
        ...
        if self.employee_id and self.contract_id.tablas_cfdi_id:
            ...
            if year_date_start < date.today().year:
                ...
                date_start = datetime.strptime(self.contract_id.date_start,"%Y-%m-%d")
            date_end = datetime.strptime(self.fecha_liquidacion,"%Y-%m-%d")
