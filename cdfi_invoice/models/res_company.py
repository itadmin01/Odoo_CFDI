...
class ResCompany(models.Model):
    ...
    serie_complemento = fields.Char(string='Serie complemento de pago') #quitar en proxima revisión
    telefono_sms = fields.Char(string='Teléfono celular') #quitar en proxima revisión
