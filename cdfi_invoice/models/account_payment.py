...
#    no_de_pago = fields.Integer("No. de pago", readonly=True)
    ...
    numero_cetificado = fields.Char(string=_('Numero de certificado'), copy=False)
    cetificaso_sat = fields.Char(string=_('Cetificado SAT'), copy=False)
    fecha_certificacion = fields.Char(string=_('Fecha y Hora Certificación'), copy=False)
    cadena_origenal = fields.Char(string=_('Cadena Original del Complemento digital de SAT'), copy=False)
    selo_digital_cdfi = fields.Char(string=_('Sello Digital del CDFI'), copy=False)
    selo_sat = fields.Char(string=_('Sello del SAT'), copy=False)
